...
namespace ru.tlpteam.tb.Runtime.Engine
{
    public class WhiteSpaceEngine
    {
        ...
        public WhiteSpaceEngine(Assembly compiledScripts, string rootPath, IWindowProvider windowProvider)
        {
        ...
        public void Run(string InitialSceneName)
        {
            ...
            try
            {
                TlpLogging.Info("Hello from TestboxedEngine (WhiteSpaceEngine because of headless mode).");
